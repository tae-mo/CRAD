...
def update_config(config):
    config.net[2].kwargs.save_recon = {'save_dir': config.feat_path}
    ...
    config.net[2].kwargs.feature_size = [s // config.net[1].kwargs.outstrides[0] for s in config.dataset.input_size]
